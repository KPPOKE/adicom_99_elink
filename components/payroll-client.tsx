...
export function PayrollClient({ rows, employees, canManage, canEdit, canDelete }: { rows: Row[]; employees: Array<{ id: number; name: string }>; canManage: boolean; canEdit: boolean; canDelete: boolean }) {
